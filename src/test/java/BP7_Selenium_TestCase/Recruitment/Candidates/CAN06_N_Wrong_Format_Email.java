...
public class CAN06_N_Wrong_Format_Email extends Candidates_Page {
    @Test
    public void Recruitment_CAN06_N_Wrong_Format_Email() throws InterruptedException {
...
//        Thread.sleep(1000);
        ...
        Rec.CandidatesInputEmail("ekki.permana66");
        Thread.sleep(1000);
        //Input Contact

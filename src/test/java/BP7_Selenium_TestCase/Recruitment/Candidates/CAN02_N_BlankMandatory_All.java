...
public class CAN02_N_BlankMandatory_All extends Candidates_Page {
    @Test
    public void Recruitment_CAN02_N_BlankMandatory_All() throws InterruptedException {
        System.out.println("Add Cancidates failed with test blank fill Mandatory only");

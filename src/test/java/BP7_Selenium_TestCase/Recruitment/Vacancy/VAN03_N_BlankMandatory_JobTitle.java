...
public class VAN03_N_BlankMandatory_JobTitle extends Vacancy_Page {
    @Test
    public void Vacancies_VAN03_N_BlankMandatory_JobTitle() throws InterruptedException {
        System.out.println("Add Vacancies with blank mandatory JobTittle");
...
//        Thread.sleep(1000);
        ...
        Rec.VacancyInputName("QA Engineerss");
        Thread.sleep(1000);

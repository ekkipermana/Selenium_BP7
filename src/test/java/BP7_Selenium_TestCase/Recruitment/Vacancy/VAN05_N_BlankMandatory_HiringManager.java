...
public class VAN05_N_BlankMandatory_HiringManager extends Vacancy_Page {
    @Test
    public void Vacancies_VAN05_N_BlankMandatory_HiringManager() throws InterruptedException {
        System.out.println("Add Vacancies with blank mandatory Hiring");
...
//
        ...
        Rec.VacancyInputName("Automations");
        Thread.sleep(1000);

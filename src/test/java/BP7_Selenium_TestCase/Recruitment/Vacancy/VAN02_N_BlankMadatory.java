...
public class VAN02_N_BlankMadatory extends Vacancy_Page{
    @Test
    public void Vacancies_VAN02_N_BlankMadatory() throws InterruptedException {
        System.out.println("Add Vacancies invalid with blank all mandatory field");
